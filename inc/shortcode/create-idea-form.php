                ...
                $html .= '<div class="user-profile-container">';
                    ...
                    $html .= '<div class="user-profile-detail">';
                        ...
                        if(!isset($options['idea_push_disable_profile_edit'])){
                            //edit link
                            $edit_link = apply_filters('idea_push_change_edit_link', '#', $currentUserId);
                            $html .= '<a class="user-profile-edit" href="'.$edit_link.'">'.__( 'Edit', 'ideapush' ).'</a>'; 
                        }
                    ...
                    if(!isset($options['idea_push_disable_profile_edit'])){
                        $html .= '<div class="user-profile-edit-form">';
                            ...
                            //submit
                            $html .= '<button data-nonce="'.wp_create_nonce( 'update_user_profile' ).'" class="update-user-profile">'.__( 'Update', 'ideapush' ).' <i class="ideapush-icon-Submit"></i></button>';
                        $html .= '</div>';
